...
public class ReferenceCompareTest extends TestCase {
  ...
  public void testReferenceCompareAllFunctions() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("allfunctions-100", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }
    
    if (entriesToTest >= 1000) {      
      runComparisonTest("allfunctions-1000", "SimpleIndex", null, "SILWrapper", linear_3_6);
      runComparisonTest("allfunctions-1000", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }

    if (entriesToTest >= 10000) {
      runComparisonTest("allfunctions-10000", "SimpleIndex", null, "SILWrapper", linear_3_6);
      runComparisonTest("allfunctions-10000", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }

    if (entriesToTest >= 100000) {  
      runComparisonTest("allfunctions-100000", "SILWrapper", rstar_1_13, "rtree.RTree3", linear_3_6);
    }
  }
  ...
  public void testReferenceCompareDelete() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("delete-100", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }
    
    if (entriesToTest >= 1000) {
      runComparisonTest("delete-1000", "SimpleIndex", null, "SILWrapper", linear_3_6);
      runComparisonTest("delete-1000", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }
    
    if (entriesToTest >= 10000) {
      runComparisonTest("delete-10000", "SimpleIndex", null, "SILWrapper", linear_3_6);
      runComparisonTest("delete-10000", "SimpleIndex", null, "rtree.RTree3", linear_3_6);
    }

    if (entriesToTest >= 100000) {
      runComparisonTest("delete-100000", "SILWrapper", rstar_1_13, "rtree.RTree3", linear_3_6);
    }
  }
  ...
  public void testReferenceCompareIntersect() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("intersect-100", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 1000) {
      runComparisonTest("intersect-1000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("intersect-1000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 10000) {
      runComparisonTest("intersect-10000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("intersect-10000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }

    if (entriesToTest >= 100000) {
      runComparisonTest("intersect-100000", "SILWrapper", rstar_1_13, "rtree.RTree3", linear_5_10);
    }
  }
  ...
  public void testReferenceCompareNearest() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("nearest-100", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 1000) {
      runComparisonTest("nearest-1000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("nearest-1000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 10000) {
      runComparisonTest("nearest-10000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("nearest-10000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }

    if (entriesToTest >= 100000) {
      runComparisonTest("nearest-100000", "SILWrapper", rstar_1_13, "rtree.RTree3", linear_5_10);
    }    
  }
  ...
  public void testReferenceCompareNearestN() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("nearestN-100", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 1000) {
      runComparisonTest("nearestN-1000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("nearestN-1000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 10000) {
      runComparisonTest("nearestN-10000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("nearestN-10000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }

    if (entriesToTest >= 100000) {
      runComparisonTest("nearestN-100000", "SILWrapper", rstar_1_13, "rtree.RTree3", linear_5_10);
    } 
  }
  ...
  public void testReferenceCompareContains() {
    ...
    if (entriesToTest >= 100) {
      ...
      runComparisonTest("contains-100", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 1000) {
      runComparisonTest("contains-1000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("contains-1000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }
    
    if (entriesToTest >= 10000) {
      runComparisonTest("contains-10000", "SimpleIndex", null, "SILWrapper", linear_5_10);
      runComparisonTest("contains-10000", "SimpleIndex", null, "rtree.RTree3", linear_5_10);
    }

    if (entriesToTest >= 100000) {
      runComparisonTest("contains-100000", "SILWrapper", rstar_6_13, "rtree.RTree3", linear_5_10);
    } 
  }
}
