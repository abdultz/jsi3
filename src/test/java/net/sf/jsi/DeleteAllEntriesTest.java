...
public class DeleteAllEntriesTest extends TestCase {
  ...
  public void testDeleteAllEntries() {
    ...
    rects = new Rectangle3[numRects];
    Random r = new Random();
    r.setSeed(0);
    for (int i = 0; i < numRects; i+=1) {
      rects[i] = new Rectangle3(r.nextFloat(), r.nextFloat(), r.nextFloat(), r.nextFloat(), r.nextFloat(), r.nextFloat());
    }
  ...
  private void run(int minNodeEntries, int maxNodeEntries, int numRects) {
    ...
    RTree3 rtree = (RTree3) SpatialIndexFactory3.newInstance("rtree.RTree3", p);
    ...
    for (int i = 0; i <= numRects; i+=100) {
      ...
      Rectangle3 testRect = new Rectangle3(1,2,3,4,5,6);
      Point3 testPoint = new Point3(1,2,3);
