...
public class MoveEntriesTest extends TestCase {
  ...
  private Rectangle3 nextRect() {
    return new Rectangle3(r.nextInt(100), r.nextInt(100), r.nextInt(100), r.nextInt(100), r.nextInt(100), r.nextInt(100));
  }
  ...
  private void run(int minNodeEntries, int maxNodeEntries, int numRects, int numMoves) {
    ...
    Rectangle3[] rects = new Rectangle3[numRects];
