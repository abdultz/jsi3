...
public class Point3 implements IShape, Cloneable
{
	...
	public boolean equals(Object o)
	{
		if (o instanceof Point3)
		{
			...
			{
				if (m_pCoords[cIndex] < pt.m_pCoords[cIndex] - SpatialIndex3.EPSILON ||
						m_pCoords[cIndex] > pt.m_pCoords[cIndex] + SpatialIndex3.EPSILON) return false;
			}
	...
	{
		if (s instanceof Region3) return ((Region3) s).contains(this);
	...
	{
		if (s instanceof Point3 && this.equals(s)) return true;

		if (s instanceof Region3) return ((Region3) s).touches(this);
	...
	{
		return new Region3(m_pCoords, m_pCoords);
	}
	...
	{
		if (s instanceof Region3) return ((Region3) s).getMinimumDistance(this);
	...
	double getMinimumDistance(final Point3 p)
	{
